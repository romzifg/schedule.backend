# 🗓️ Microservice Appointment System
...
- GraphQL API
- JWT Authentication
- Inter-service authentication (Auth Service → Schedule Service)
- Prisma ORM
- Unit Test & E2E Test
...
```env.test
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/schedule_db_test
AUTH_SERVICE_URL=http://auth-service:3001/graphql
```
...
AUTH_DATABASE_URL=postgresql://postgres:postgres@postgres:5432/app_db?schema=auth
SCHEDULE_DATABASE_URL=postgresql://postgres:postgres@postgres:5432/app_db?schema=schedule
...
## 👨‍💻 Author
Backend microservice implementation – production ready architecture.
